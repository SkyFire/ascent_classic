...
enum ServerHookEvents
{
	...
	SERVER_HOOK_EVENT_ON_POST_LEVELUP		= 23,
	SERVER_HOOK_EVENT_ON_POST_RESURRECT		= 24,
...
typedef void(*tOnPostResurrect)(Player * pPlayer);
...
public:
	...
	void OnPostResurrect(Player * pPlayer);
};
