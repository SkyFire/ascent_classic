...
/*						//paladin - illumination
					...
					case 22858: //retatliation needs target to be not in front. Can be casted by creatures too
						{
							if ( isInBack(victim) )
								continue; 
						}break;
					case 974: // Earth Shield handler
					case 32593: // Earth Shield handler
					case 32594: // Earth Shield handler
						{
							SpellEntry *spellInfo = dbcSpell.LookupEntry(spellId );
							Spell *spell = new Spell(this, spellInfo ,true, NULL);
...
//------------------------------by school----------------------------------------------
	...
	//summaryPCTmod += caster->GetDamageDonePctMod(school);			// CAUSES HIGH DAMAGE
