...
void CommandTableStorage::Init()
{
	static ChatCommand unitCommandTable[] =
	{
		...
		{ "npcfollow", 'u', &ChatHandler::HandleNpcFollowCommand, "Sets npc to follow you", NULL, 0, 0, 0 },
		{ "nullfollow", 'u', &ChatHandler::HandleNullFollowCommand, "Sets npc to not follow anything", NULL, 0, 0, 0 },
		{ "formationlink1", 'u', &ChatHandler::HandleFormationLink1Command, "Sets formation master.", NULL, 0, 0, 0 },
		{ "formationlink2", 'u', &ChatHandler::HandleFormationLink2Command, "Sets formation slave with distance and angle", NULL, 0, 0, 0 },
		{ "formationclear", 'u', &ChatHandler::HandleFormationClearCommand, "Removes formation from creature", NULL, 0, 0, 0 },
	...
	static ChatCommand teleCommandTable[] =
	{
		...
		{ "worldport",   't', &ChatHandler::HandleWorldPortCommand,	 "",							   NULL, 0, 0, 0},
	...
	static ChatCommand serverCommandTable[] =
	{
		...
		{ "playsound", 'z', &ChatHandler::HandleGlobalPlaySoundCommand, "Plays a sound to the entire server.", NULL, 0, 0, 0 },
		{ "rehashconfig", 'z', &ChatHandler::HandleRehashCommand, "Reloads config file.", NULL, 0, 0, 0 },
