			...
			case 4:
				{
					...
					if(shield)
					{
						...
						blocked_damage = pVictim->GetUInt32Value( PLAYER_RATING_MODIFIER_BLOCK ) * ( ( 100 + static_cast< Player* >( pVictim )->m_modblockvaluefromspells ) / 100 ) + ( ( pVictim->GetUInt32Value( UNIT_FIELD_STAT0 ) / 20 ) - 1 );
