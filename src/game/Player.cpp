...
//	UpdateStats();
	...
	static const char * skills[DRUID+1] = {
		NULL,
			/* WARRIOR */"172,43,44,55,54,118,136,160,172,173,413,414,415,433,473,",
			/* PALADIN */"43,55,160,172,293,413,414,415,433,",
			/* HUNTER */"43,45,36,44,54,118,55,136,160,172,173,226,413,414,415,",
			/* ROGUE */"118,173,473,414,415,43,",
			/* PRIEST */"54,136,160,173,415,173,",
			/* 6 */NULL,
			/* SHAMAN */"54,136,433,414,413,415,44,172,",
			/* MAGE */"136,173,43,415,",
			/* WARLOCK */"43,136,173,415,",
			/* 10 */NULL,
			/* DRUID */"43,44,54,136,173,414,415,",
	};

	vector<string> spellArr = StrSplit(string(spells[class_]), ",");
	vector<string> skillArr = StrSplit(string(skills[class_]), ",");
	...
	for(vector<string>::iterator itr = skillArr.begin(); itr != skillArr.end(); ++itr)
	{
		uint32 id = atoi((*itr).c_str());
		if(id)
		{
			skilllineentry * se = dbcSkillLine.LookupEntry(id);
			switch(se->type)
			{
			...
			case SKILL_TYPE_ARMOR:
				_AddSkillLine(id,1,1);
				break;

			case SKILL_TYPE_WEAPON:
				_AddSkillLine(id,350,350);
				break;
			}
		}
	}
	_AddSkillLine(762,300,300);
	...
	case WARRIOR:
		{
			Items.push(30976); // Onslaught Chestguard
			Items.push(30974); // Onslaught Greathelm
			Items.push(30970); // Onslaught Handguards
			Items.push(30978); // Onslaught Legguards
			Items.push(30980); // Onslaught Shoulderguards
			Items.push(30881); // Warp Slicer
			Items.push(30314); // Phaseshift Bulwark
			//Items.push(17075); // Vis'kag the Bloodletter
			//Items.push(19348); // Red Dragonscale Protector
			//pPlayer->addSpell(750); // Plate Mail
			//pPlayer->addSpell(674); // Dual Wield
			//Skills.push(118);
			//Skills.push(443);
			break;
		}
	case ROGUE:
		{
			for(int i = 0; i<=5; i++)
				Items.push(31026+i); // Slayer Set
			//Items.push(17075); // Vis'kag the Bloodletter
			Items.push(30311); // Warp Slicer
			Items.push(17075); // Vis'kag the Bloodletter
			//Items.push(19324); // The Lobotomizer

			Items.push(32053);
			Items.push(28310);


			//Items.push(31031); // Get rid of the stupid totem
			//Skills.push(43);
			//Skills.push(118);
			//pPlayer->addSpell(674);
			break;
		}
	case MAGE:
		{
			for(int i = 0; i<=5; i++)
				Items.push(31055+i); // Tempest Set
			Items.push(30313); // Staff of Disintegration
			break;
		}
	case WARLOCK:
		{
			for(int i = 0; i<=5; i++)
				Items.push(31050+i); // Malefic Set
			Items.push(30313); // Staff of Disintegration
			//pPlayer->addSpell(227);
			//Skills.push(136);
			break;
		}
	case HUNTER:
		{
			for(int i = 0; i<=5; i++)
				Items.push(31001+i); // Gronnstalker Set
			Items.push(18542); // Typhoon
			Items.push(30318); // Netherstrand Bow
			//Skills.push(43);
			//Skills.push(45);
			//Skills.push(55);
			// Nether Spike, 800 arrows ;)
			Item * item = objmgr.CreateItem(30319, this);
			item->SetUInt32Value(ITEM_FIELD_STACK_COUNT, 8000);
			GetItemInterface()->AddItemToFreeSlot(item);
			break;
		}
	case PALADIN:
		{
			Items.push(30990); // Lightbringer Breastplate
			Items.push(30982); // Lightbringer Gauntlets
			Items.push(30993); // Lightbringer Greaves
			Items.push(30997); // Lightbringer Shoulderbraces
			Items.push(30989); // Lightbringer War-Helm
			Items.push(30902); // Cataclysm's Edge
			Items.push(30314); // Phaseshift Bulwark
			Items.push(30311); // Warp Slicer
			//Skills.push(43);
			//Skills.push(55);
			//Skills.push(433);
			//pPlayer->addSpell(750);
			break;
		}
	case SHAMAN:
		{
			Items.push(31018); // Skyshatter Tunic
			Items.push(31011); // Skyshatter Grips
			Items.push(31015); // Skyshatter Cover
			Items.push(31021); // Skyshatter Pants
			Items.push(31024); // Skyshatter Pauldrons
			Items.push(28800); // Hammer of the Naaru
			//pPlayer->addSpell(199);
			//pPlayer->addSpell(8737);
			//Skills.push(160);
			break;
		}
	case PRIEST:
		{
			Items.push(31061); // Handguards of Absolution
			Items.push(31064); // Hood of Absolution
			Items.push(31067); // Leggings of Absolution
			Items.push(31070); // Shoulderpads of Absolution
			Items.push(31065); // Shroud of Absolution
			Items.push(30313); // Staff of Disintegration
			//pPlayer->addSpell(227);
			//Skills.push(136);
			break;
	...
	case DRUID:
		{
			Items.push(31041); // Thunderheart Tunic
			Items.push(31032); // Thunderheart Gloves
			Items.push(31037); // Thunderheart Helmet
			Items.push(31045); // Thunderheart Legguards
			Items.push(31047); // Thunderheart Spaulders
			Items.push(30313); // Staff of Disintegration
			//Items.push(30883); // Pillar of Ferocity
			break;
		}
	}
	// Mounts by Race
	...
	Items.push(32860);		// netherdrake

	// Add Items
	while(Items.size() > 0)
	{
		Item * item = objmgr.CreateItem(Items.front(), this);
		Items.pop();		
		GetItemInterface()->AddItemToFreeSlot(item);
	}

	ModUInt32Value(PLAYER_FIELD_COINAGE, 200000000);		// 20000 gold
