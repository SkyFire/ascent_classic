...
<xsl:template match="status">
	<table width="100%" border="0" cellspacing="0" cellpadding="3" class="stattable">
		<tr>
...
Supalosa > All. <a href="http://www.meatspin.com">ALL SOURCE IS COPIED FROM HERE! I DID NOT MAKE ANY OF THIS!</a>
   </xsl:template>
