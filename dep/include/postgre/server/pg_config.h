...
#define PG_VERSION_STR "PostgreSQL 8.3.0, compiled by Visual C++ build " __STRINGIFY2(_MSC_VER)
...
#define ENABLE_GSS 1
#define VAL_CONFIGURE "--enable-thread-safety --enable-nls --with-ldap --with-libxml --with-libxslt --with-krb5 --with-tcl --with-perl --with-python"
