...
CREATE TABLE `creature_spawns` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8885980 DEFAULT CHARSET=latin1 COMMENT='Spawn System';
...
) ENGINE=MyISAM AUTO_INCREMENT=618522 DEFAULT CHARSET=latin1 PACK_KEYS=0 ROW_FORMAT=FIXED COMMENT='Loot System';
...
CREATE TABLE `gameobject_spawns` (
  ...
  PRIMARY KEY  (`id`),
  KEY `Map` (`map`)
) ENGINE=MyISAM AUTO_INCREMENT=33900 DEFAULT CHARSET=cp1251 COLLATE=cp1251_general_cs PACK_KEYS=0 ROW_FORMAT=FIXED COMMENT='Spawn System';
...
) ENGINE=MyISAM AUTO_INCREMENT=2522 DEFAULT CHARSET=latin1 COMMENT='Loot System';
...
CREATE TABLE `objectloot` (
  ...
  UNIQUE KEY `index` (`index`),
  KEY `entryid` (`entryid`)
) ENGINE=MyISAM AUTO_INCREMENT=4252 DEFAULT CHARSET=latin1 COMMENT='Loot System';
